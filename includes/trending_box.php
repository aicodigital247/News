...
if ($res) {
    ...
    while ($row = $res->fetch_assoc()) {
        ...
        echo '<a href="' . UrlManager::getArticleUrl($row['slug']) . '" class="font-bold text-slate-800 hover:text-[#bb1919] transition leading-snug block">' . htmlspecialchars($row['title']) . '</a>';
