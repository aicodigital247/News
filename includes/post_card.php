    ...
    <div>
        <div class="relative h-48 bg-slate-900 overflow-hidden">
            ...
            <span class="absolute top-3 left-3 bg-[#bb1919] text-white text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-xs">
                <a href="<?php echo UrlManager::getCategoryUrl($post['category']); ?>" class="text-white hover:underline"><?php echo htmlspecialchars($post['category']); ?></a>
            </span>
        </div>
        <div class="p-4 space-y-2">
            ...
            <h3 class="font-bold text-base leading-tight hover:text-[#bb1919] transition">
                <a href="<?php echo UrlManager::getArticleUrl($post['slug']); ?>"><?php echo htmlspecialchars($post['title']); ?></a>
            </h3>
